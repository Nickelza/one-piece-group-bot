...
def get_context_data(context: ContextTypes.DEFAULT_TYPE, data_type: ContextDataType, key: ContextDataKey,
                     inner_key: str = None, tolerate_key_exception: bool = True) -> any:
    """
...
def set_context_data(context: ContextTypes.DEFAULT_TYPE, data_type: ContextDataType, key: ContextDataKey, value: any,
...
def remove_context_data(context: ContextTypes.DEFAULT_TYPE, data_type: ContextDataType, key: ContextDataKey,
                        inner_key: str = None) -> None:
    """
...
def get_bot_context_data(context: CallbackContext, key: ContextDataKey, inner_key: str = None,
                         tolerate_key_exception: bool = True) -> any:
    """
    Get the bot context data
    :param context: The context
    :param key: The key
...
def set_bot_context_data(context: CallbackContext, key: ContextDataKey, value: any, inner_key: str = None) -> None:
    """
    Set the bot context data
    :param context: The context
    :param key: The key
...
def get_user_context_data(context: CallbackContext, key: ContextDataKey, inner_key: str = None,
                          tolerate_key_exception: bool = True) -> any:
    """
...
def set_user_context_data(context: CallbackContext, key: ContextDataKey, value: any, inner_key: str = None) -> None:
    """
