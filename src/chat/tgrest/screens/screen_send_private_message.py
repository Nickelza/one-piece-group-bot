...
async def manage(context: ContextTypes.DEFAULT_TYPE, tg_rest_private_message: TgRestPrivateMessage):
    """
    ...
    try:
        await full_message_send(context, tg_rest_private_message.message, chat_id=tg_rest_private_message.tg_user_id)
