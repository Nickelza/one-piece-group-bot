...
from src.chat.private.screens.screen_prediction_detail_place_bet import PredictionPlaceBetReservedKeys
...
from src.service.message_service import full_message_send, get_create_or_edit_status, escape_valid_markdown_chars
...
async def manage(update: Update, context: ContextTypes.DEFAULT_TYPE, inbound_keyboard: Keyboard, user: User) -> None:
    ...
    if not should_ignore_input:
        ...
        if inbound_keyboard is not None:
            ...
            prediction_option: PredictionOption = PredictionOption.get_by_id(user.private_screen_in_edit_id)
