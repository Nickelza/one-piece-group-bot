...
async def manage(update: Update, context: ContextTypes.DEFAULT_TYPE, inbound_keyboard: Keyboard, user: User) -> None:
    ...
    if user.is_crew_captain() and user != member:
        ...
        if not crew.has_first_mate() and crew.can_promote_first_mate:
            inline_keyboard.append([Keyboard(phrases.PVT_KEY_CREW_MEMBER_FIRST_MATE_PROMOTE,
        ...
        if member.is_crew_first_mate():
            inline_keyboard.append([Keyboard(phrases.PVT_KEY_CREW_MEMBER_FIRST_MATE_DEMOTE,
