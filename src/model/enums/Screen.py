...
class Screen(StrEnum):
    ...
    PVT_PLUNDER = "P67"
    PVT_DOC_Q_GAME = "P68"
    PVT_DAILY_REWARD = "P69"
    PVT_DAILY_REWARD_PRIZE = "P70"
    PVT_GAME_GLOBAL_START_CHALLENGER = "P71"
    PVT_ROCK_PAPER_SCISSORS_GAME = "P72"
    PVT_GAME_GLOBAL_START_OPPONENT = "P73"
    PVT_GAME_GLOBAL_LIST = "P74"
    PVT_GAME = "P75"
...
ALLOW_DEEPLINK = [
    ...
    Screen.PVT_POST_BAIL,
    Screen.PVT_GAME_GLOBAL_START_CHALLENGER,
    Screen.PVT_GAME_GLOBAL_START_OPPONENT,
    Screen.PVT_DEVIL_FRUIT_SHOP,
    Screen.PVT_GAME_GLOBAL_LIST,
]
