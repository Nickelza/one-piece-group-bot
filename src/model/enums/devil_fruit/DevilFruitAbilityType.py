...
DEVIL_FRUIT_ABILITY_TYPE_DESCRIPTION_MAP = {
    ...
    DevilFruitAbilityType.FIGHT_PLUNDER_SCOUT_FEE: phrases.ABILITY_TYPE_FIGHT_PLUNDER_SCOUT_FEE,
}
...
DEVIL_FRUIT_ABILITY_TYPE_SIGN_MAP = {
    ...
    DevilFruitAbilityType.FIGHT_PLUNDER_SCOUT_FEE: Sign.NEGATIVE,
}
