...
DEVIL_FRUIT_ABILITY_TYPE_SIGN_MAP = {
    ...
    DevilFruitAbilityType.FIGHT_SCOUT_FEE: Sign.NEGATIVE,
    DevilFruitAbilityType.PLUNDER_SCOUT_FEE: Sign.NEGATIVE,
    DevilFruitAbilityType.GAME_GLOBAL_ACCEPT_COOLDOWN_DURATION: Sign.NEGATIVE,
}
