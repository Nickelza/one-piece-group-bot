...
DEVIL_FRUIT_ABILITY_TYPE_DESCRIPTION_MAP = {
    ...
    DevilFruitAbilityType.FIGHT_PLUNDER_SCOUT_PRICE: (
        phrases.ABILITY_TYPE_FIGHT_PLUNDER_SCOUT_PRICE
    ),
}
...
DEVIL_FRUIT_ABILITY_TYPE_SIGN_MAP = {
    ...
    DevilFruitAbilityType.FIGHT_PLUNDER_SCOUT_PRICE: Sign.NEGATIVE,
}
