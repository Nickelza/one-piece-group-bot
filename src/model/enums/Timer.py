...
REDDIT_POST_ONE_PIECE = Timer(
    ...
    Env.ENABLE_TIMER_REDDIT_POST_ONE_PIECE.get_bool() and Env.ENABLE_REDDIT_POSTS.get_bool(),
...
REDDIT_POST_MEME_PIECE = Timer(
    ...
    Env.ENABLE_TIMER_REDDIT_POST_MEME_PIECE.get_bool() and Env.ENABLE_REDDIT_POSTS.get_bool(),
...
# Fight and plunder scout count decrease
FIGHT_PLUNDER_SCOUT_COUNT_DECREASE = Timer(
    "FIGHT_PLUNDER_SCOUT_COUNT_DECREASE",
    Env.CRON_FIGHT_PLUNDER_SCOUT_COUNT_DECREASE.get(),
    Env.ENABLE_TIMER_FIGHT_PLUNDER_SCOUT_COUNT_DECREASE.get_bool(),
