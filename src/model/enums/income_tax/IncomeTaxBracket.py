...
class IncomeTaxBracket:
    ...
    def get_tax_breakdown(starting_amount: int, amount: int) -> list[IncomeTaxBreakdown]:
        ...
        while remaining_amount > 0:
            ...
            tax_info.append(IncomeTaxBreakdown(taxable_amount, current_bracket.percentage, int(tax_amount)))
...
TAX_BRACKET_1 = IncomeTaxBracket(Env.TAX_BRACKET_1_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_1_PERCENTAGE.get_float())
TAX_BRACKET_2 = IncomeTaxBracket(Env.TAX_BRACKET_2_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_2_PERCENTAGE.get_float())
TAX_BRACKET_3 = IncomeTaxBracket(Env.TAX_BRACKET_3_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_3_PERCENTAGE.get_float())
TAX_BRACKET_4 = IncomeTaxBracket(Env.TAX_BRACKET_4_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_4_PERCENTAGE.get_float())
TAX_BRACKET_5 = IncomeTaxBracket(Env.TAX_BRACKET_5_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_5_PERCENTAGE.get_float())
# noinspection DuplicatedCode
TAX_BRACKET_6 = IncomeTaxBracket(Env.TAX_BRACKET_6_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_6_PERCENTAGE.get_float())
TAX_BRACKET_7 = IncomeTaxBracket(Env.TAX_BRACKET_7_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_7_PERCENTAGE.get_float())
TAX_BRACKET_8 = IncomeTaxBracket(Env.TAX_BRACKET_8_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_8_PERCENTAGE.get_float())
TAX_BRACKET_9 = IncomeTaxBracket(Env.TAX_BRACKET_9_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_9_PERCENTAGE.get_float())
TAX_BRACKET_10 = IncomeTaxBracket(Env.TAX_BRACKET_10_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_10_PERCENTAGE.get_float())
TAX_BRACKET_11 = IncomeTaxBracket(Env.TAX_BRACKET_11_TOTAL_BOUNTY.get_int(), Env.TAX_BRACKET_11_PERCENTAGE.get_float())

TAX_BRACKETS = [TAX_BRACKET_0, TAX_BRACKET_1, TAX_BRACKET_2, TAX_BRACKET_3, TAX_BRACKET_4, TAX_BRACKET_5, TAX_BRACKET_6,
                TAX_BRACKET_7, TAX_BRACKET_8, TAX_BRACKET_9, TAX_BRACKET_10, TAX_BRACKET_11]
